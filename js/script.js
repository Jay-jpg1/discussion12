...
let resetradioButton = document.querySelector('#radio-reset-buttion');
resetradioButton.addEventListener('click', function(){
    let radioButtons = document.querySelectorAll('input[name="favorite_day"]');radioButtons.forEach(function (radio){
        radio.checked = false;
    })
